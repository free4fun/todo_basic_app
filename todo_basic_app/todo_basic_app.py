"""This module provides the To-Do Basic App model-controller."""

from pathlib import Path
from typing import Any, Dict, List, NamedTuple
from datetime import datetime, timedelta
from todo_basic_app import DB_READ_ERROR, ID_ERROR
from todo_basic_app.database import DatabaseHandler
...
class Todoer:
    ...
    def add(self, description: List[str], date: datetime, priority: int = 3) -> CurrentTodo:
